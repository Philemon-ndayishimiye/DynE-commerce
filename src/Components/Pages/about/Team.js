    ...
    <OurStory/>
      ...
      <div class="lg:max-w-5xl md:max-w-3xl max-w-xl mx-auto">
        <div class="max-w-2xl mx-auto text-center">
          ...
          <p class="text-slate-600 text-sm mt-4 leading-relaxed">Meet our team of professionals to serve you.</p>
        </div>
          ...
          <div class="border border-gray-200 rounded-lg overflow-hidden">
            ...
            <div class="p-4">
              ...
              <div class="space-x-4 mt-4">
                ...
                <button type="button"
                  class="w-6 h-6 inline-flex items-center justify-center cursor-pointer rounded-full border-none outline-none bg-[#0077b5] hover:bg-[#0055b5]">
